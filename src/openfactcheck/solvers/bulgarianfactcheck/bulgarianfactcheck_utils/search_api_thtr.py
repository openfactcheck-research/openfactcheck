        ...
        if snippets_split_length <= int(os.environ.get("EVIDENCE_THRESHOLD", 5)):
            ...
            messages_list = [
                [
                    ...
                    {
                        "role": "user",
                        "content": self.bulgarian_to_english_translation_prompt[
                            "user"
                        ].format(input=query),
                    },
                ]
            ...
            for snippet_split in snippets_split_en:
                ...
                bulgarian_snippets = self.gpt.run(messages_list, str)
                translated_snippet = []
                for bulgarian_snippet in bulgarian_snippets:
                    translated_snippet.append({"content": bulgarian_snippet})
