...
class GoogleSerperAPIWrapper:
    ...
    def __init__(self, snippet_cnt=10) -> None:
        ...
        self.english_to_bulgarian_translation_prompt = ENGLISH_TO_BULGARIAN_TRANSLATION_PROMPT
        self.bulgarian_to_english_translation_prompt = BULGARIAN_TO_ENGLISH_TRANSLATION_PROMPT
    ...
    def run(self, queries):
        ...
        then translating the snippets back to Bulgarian—no thresholding."""
        ...
        # 1) Translate all Bulgarian queries into English
        messages_to_en = [
            [
                {
                    "role": "system",
                    "content": self.bulgarian_to_english_translation_prompt["system"],
                },
                {
                    "role": "user",
                    "content": self.bulgarian_to_english_translation_prompt["user"].format(
                        input=query
                    ),
                },
            ]
        ...
        # 4) Translate each snippet back into Bulgarian
        final_snippets = []
        for snippet_list in snippets_pairs:
            ...
            messages_to_ur = [
                [
                    {
                        "role": "system",
                        "content": self.english_to_bulgarian_translation_prompt["system"],
                    },
                    {
                        "role": "user",
                        "content": self.english_to_bulgarian_translation_prompt[
                            "user"
