...
from .bulgarianfactcheck_utils.chat_api import OpenAIChat, AnthropicChat
from .bulgarianfactcheck_utils.search_api_thtr import GoogleSerperAPIWrapper
from .bulgarianfactcheck_utils.prompt import QUERY_GENERATION_PROMPT


@Solver.register(
    "bulgarianfactcheck_thresholded_translator_retriever", "claims", "claims_with_evidences"
)
