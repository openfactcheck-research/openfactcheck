...
from .bulgarianfactcheck_utils.prompt import CLAIM_EXTRACTION_PROMPT


@Solver.register("bulgarianfactcheck_claimprocessor", "response", "claims")
class BulgarianFactCheckClaimProcessor(StandardTaskSolver):
