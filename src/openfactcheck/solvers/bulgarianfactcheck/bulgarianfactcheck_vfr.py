...
from .bulgarianfactcheck_utils.prompt import VERIFICATION_PROMPT


@Solver.register("bulgarianfactcheck_verifier", "claims_with_evidences", "label")
class BulgarianFactCheckVerifier(StandardTaskSolver):
