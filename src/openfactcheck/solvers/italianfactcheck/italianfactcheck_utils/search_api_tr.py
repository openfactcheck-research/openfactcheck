...
class GoogleSerperAPIWrapper:
    ...
    def __init__(self, snippet_cnt=10) -> None:
        ...
        self.english_to_italian_translation_prompt = ENGLISH_TO_ITALIAN_TRANSLATION_PROMPT
        self.italian_to_english_translation_prompt = ITALIAN_TO_ENGLISH_TRANSLATION_PROMPT
    ...
    def run(self, queries):
        ...
        then translating the snippets back to Italian—no thresholding."""
        ...
        # 1) Translate all Italian queries into English
        messages_to_en = [
            [
                {
                    "role": "system",
                    "content": self.italian_to_english_translation_prompt["system"],
                },
                {
                    "role": "user",
                    "content": self.italian_to_english_translation_prompt["user"].format(
                        input=query
                    ),
                },
            ]
        ...
        # 4) Translate each snippet back into Italian
        final_snippets = []
        for snippet_list in snippets_pairs:
            ...
            messages_to_ur = [
                [
                    {
                        "role": "system",
                        "content": self.english_to_italian_translation_prompt["system"],
                    },
                    {
                        "role": "user",
                        "content": self.english_to_italian_translation_prompt[
                            "user"
