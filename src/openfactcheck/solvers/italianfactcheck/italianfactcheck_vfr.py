...
from .italianfactcheck_utils.prompt import VERIFICATION_PROMPT


@Solver.register("italianfactcheck_verifier", "claims_with_evidences", "label")
class ItalianFactCheckVerifier(StandardTaskSolver):
