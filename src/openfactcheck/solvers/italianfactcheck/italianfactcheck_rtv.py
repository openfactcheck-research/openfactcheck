...
from .italianfactcheck_utils.chat_api import OpenAIChat
from .italianfactcheck_utils.search_api import GoogleSerperAPIWrapper
from .italianfactcheck_utils.prompt import QUERY_GENERATION_PROMPT


@Solver.register("italianfactcheck_retriever", "claims", "claims_with_evidences")
class FactoolRetriever(StandardTaskSolver):
    def __init__(self, args):
        ...
        self.search_engine = GoogleSerperAPIWrapper(
            snippet_cnt=self.snippet_cnt, language="it"
        )
