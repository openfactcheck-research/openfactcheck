...
from .italianfactcheck_utils.chat_api import OpenAIChat, AnthropicChat
from .italianfactcheck_utils.search_api_thtr import GoogleSerperAPIWrapper
from .italianfactcheck_utils.prompt import QUERY_GENERATION_PROMPT


@Solver.register(
    "italianfactcheck_thresholded_translator_retriever", "claims", "claims_with_evidences"
)
