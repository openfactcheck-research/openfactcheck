...
from .italianfactcheck_utils.prompt import CLAIM_EXTRACTION_PROMPT


@Solver.register("italianfactcheck_claimprocessor", "response", "claims")
class ItalianFactCheckClaimProcessor(StandardTaskSolver):
