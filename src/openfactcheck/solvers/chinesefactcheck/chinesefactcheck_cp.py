...
from .chinesefactcheck_utils.prompt import CLAIM_EXTRACTION_PROMPT


@Solver.register("chinesefactcheck_claimprocessor", "response", "claims")
class ChineseFactCheckClaimProcessor(StandardTaskSolver):
