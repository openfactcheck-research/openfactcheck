...
from .chinesefactcheck_utils.prompt import VERIFICATION_PROMPT


@Solver.register("chinesefactcheck_verifier", "claims_with_evidences", "label")
class ChineseFactCheckVerifier(StandardTaskSolver):
