...
from .chinesefactcheck_utils.chat_api import OpenAIChat, AnthropicChat
from .chinesefactcheck_utils.search_api_thtr import GoogleSerperAPIWrapper
from .chinesefactcheck_utils.prompt import QUERY_GENERATION_PROMPT


@Solver.register(
    "chinesefactcheck_thresholded_translator_retriever", "claims", "claims_with_evidences"
)
class ChineseFactCheckThresholdedTranslatorRetriever(StandardTaskSolver):
