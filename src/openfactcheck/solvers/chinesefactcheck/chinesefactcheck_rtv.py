...
from .chinesefactcheck_utils.chat_api import OpenAIChat
from .chinesefactcheck_utils.search_api import GoogleSerperAPIWrapper
from .chinesefactcheck_utils.prompt import QUERY_GENERATION_PROMPT


@Solver.register("chinesefactcheck_retriever", "claims", "claims_with_evidences")
class ChineseFactCheckRetriever(StandardTaskSolver):
    def __init__(self, args):
        ...
        self.search_engine = GoogleSerperAPIWrapper(
            snippet_cnt=self.snippet_cnt, language="zh-cn"
        )
