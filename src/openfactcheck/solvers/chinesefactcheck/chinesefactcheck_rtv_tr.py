...
from .chinesefactcheck_utils.search_api_tr import GoogleSerperAPIWrapper
from .chinesefactcheck_utils.prompt import QUERY_GENERATION_PROMPT


@Solver.register("chinesefactcheck_translator_retriever", "claims", "claims_with_evidences")
class ChineseFactCheckTranslatorRetriever(StandardTaskSolver):
