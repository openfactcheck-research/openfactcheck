...
class GoogleSerperAPIWrapper:
    ...
    def __init__(self, snippet_cnt=10) -> None:
        ...
        self.english_to_chinese_translation_prompt = ENGLISH_TO_CHINESE_TRANSLATION_PROMPT
        self.chinese_to_english_translation_prompt = CHINESE_TO_ENGLISH_TRANSLATION_PROMPT
    ...
    def run(self, queries):
        ...
        messages_to_en = [
            [
                {
                    "role": "system",
                    "content": self.chinese_to_english_translation_prompt["system"],
                },
                {
                    "role": "user",
                    "content": self.chinese_to_english_translation_prompt["user"].format(
                        input=query
                    ),
                },
            ]
        ...
        for snippet_list in snippets_pairs:
            ...
            messages_to_zh = [
                [
                    {
                        "role": "system",
                        "content": self.english_to_chinese_translation_prompt["system"],
                    },
                    {
                        "role": "user",
                        "content": self.english_to_chinese_translation_prompt[
                            "user"
