...
from .arabicfactcheck_utils.search_api_tr import GoogleSerperAPIWrapper
from .arabicfactcheck_utils.prompt import QUERY_GENERATION_PROMPT


@Solver.register("arabicfactcheck_translator_retriever", "claims", "claims_with_evidences")
class ArabicFactCheckTranslatorRetriever(StandardTaskSolver):
