...
class GoogleSerperAPIWrapper:
    ...
    def __init__(self, snippet_cnt=10) -> None:
        ...
        self.english_to_arabic_translation_prompt = ENGLISH_TO_ARABIC_TRANSLATION_PROMPT
        self.arabic_to_english_translation_prompt = ARABIC_TO_ENGLISH_TRANSLATION_PROMPT
    ...
    def run(self, queries):
        ...
        then translating the snippets back to Arabic—no thresholding."""
        ...
        # 1) Translate all Arabic queries into English
        messages_to_en = [
            [
                {
                    "role": "system",
                    "content": self.arabic_to_english_translation_prompt["system"],
                },
                {
                    "role": "user",
                    "content": self.arabic_to_english_translation_prompt["user"].format(
                        input=query
                    ),
                },
            ]
        ...
        # 4) Translate each snippet back into Arabic
        final_snippets = []
        for snippet_list in snippets_pairs:
            ...
            messages_to_ar = [
                [
                    {
                        "role": "system",
                        "content": self.english_to_arabic_translation_prompt["system"],
                    },
                    {
                        "role": "user",
                        "content": self.english_to_arabic_translation_prompt[
                            "user"
