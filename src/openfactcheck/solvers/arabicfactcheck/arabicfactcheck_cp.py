...
from .arabicfactcheck_utils.prompt import CLAIM_EXTRACTION_PROMPT


@Solver.register("arabicfactcheck_claimprocessor", "response", "claims")
class ArabicFactCheckClaimProcessor(StandardTaskSolver):
