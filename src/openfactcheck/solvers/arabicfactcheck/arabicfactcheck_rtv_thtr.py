...
from .arabicfactcheck_utils.chat_api import OpenAIChat, AnthropicChat
from .arabicfactcheck_utils.search_api_thtr import GoogleSerperAPIWrapper
from .arabicfactcheck_utils.prompt import QUERY_GENERATION_PROMPT


@Solver.register(
    "arabicfactcheck_thresholded_translator_retriever", "claims", "claims_with_evidences"
)
class ArabicFactCheckThresholdedTranslatorRetriever(StandardTaskSolver):
