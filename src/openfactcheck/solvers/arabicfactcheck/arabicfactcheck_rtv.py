...
from .arabicfactcheck_utils.chat_api import OpenAIChat
from .arabicfactcheck_utils.search_api import GoogleSerperAPIWrapper
from .arabicfactcheck_utils.prompt import QUERY_GENERATION_PROMPT


@Solver.register("arabicfactcheck_retriever", "claims", "claims_with_evidences")
class ArabicFactCheckRetriever(StandardTaskSolver):
    def __init__(self, args):
        ...
        self.search_engine = GoogleSerperAPIWrapper(
            snippet_cnt=self.snippet_cnt, language="ar"
        )
