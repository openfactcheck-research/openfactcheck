...
from .arabicfactcheck_utils.prompt import VERIFICATION_PROMPT


@Solver.register("arabicfactcheck_verifier", "claims_with_evidences", "label")
class ArabicFactCheckVerifier(StandardTaskSolver):
